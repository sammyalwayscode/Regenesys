...
const Produce = () => {
  ...
  const getAllProduct = async () => {
    const res = await axios.get(
      "https://red-cart-be.onrender.com/api/product/getallproduct"
    );
              ...
              >
                <div className="h-56 w-full">
                  <a href="#">
                    ...
                    />
                    <img
                      className="mx-auto hidden object-cover  h-full dark:block"
                      src={prod.productImage}
                      alt=""
                    />
                  </a>
                ...
                <div className="pt-6">
                  ...
                  <Link to={`/product/detail/${prod._id}`}>
                    <span className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">
                      {prod.productTitle}
                    </span>
                  </Link>
